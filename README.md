...
|---|---|---|
| Android Profiler | Runtime only — no source analysis | ❌ |
| SonarQube / Lint | Single-file pattern matching | ❌ |
...
| **IBM Bob 2.0** | **Full repository context as first-class primitive** | ✅ |
...
Confirmed by:  dumpsys shows SyncService holding wakelock 340ms
               average per trigger × 96 triggers/day = 32.6 seconds
...
# Go to: https://github.com/Code-and-Chaos/ecotrace/releases

# Or build from source:
git clone https://github.com/Code-and-Chaos/ecotrace.git
cd ecotrace
npm install
cargo tauri build
```
...
├── src-tauri/
│   └── src/
│       └── main.rs              ← Tauri commands: adb, file read, dir walk
├── src/
